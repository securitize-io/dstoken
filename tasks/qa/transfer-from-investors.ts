...
task('transfer-from-investors', 'Execute transferFrom between two investor wallets')
  ...
  .setAction(async (args, hre) => {
    ...
    if (!fs.existsSync(file)) {
      ...
      console.log('  npx hardhat transfer-from-investors --file scripts/config/transfer-from-investors.json --network sepolia');
      console.log('  npx hardhat transfer-from-investors --file scripts/output/create-investor+timestamp.json --network sepolia');
      process.exit(1);
    }
    ...
    console.log('\n📖 For more information, see: scripts/config/transfer-from-investors.md');

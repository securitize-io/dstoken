...
Independent audits of the current implementation were performed by [Cyfrin](audits/2025-10-10-cyfrin-securitize-dstoken-v4-2.1.pdf) and [Halborn](audits/2025-10-09-Halborn-DSToken_v4_SSC.pdf), plus additional Cyfrin audits on the [permissionless compliance diff](audits/2026-06-04-cyfrin-securitize-compliance-permissionless-diff-v2.0.pdf) and the [global denylist](audits/2026-09-11-cyfrin-securitize-evm-globaldenylist-v2.0.pdf), and can be found in the /audits folder.

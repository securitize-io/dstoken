...
contract('Integration', function ([
  ...
  describe('Transfers', function () {
    it('Should allow some transfers and update the number of eu and us investors', async function () {
      ...
      const usInvestorsCount = await this.complianceService.getUSInvestorsCount.call();
      ...
      const euRetailInvestorsCount = await this.complianceService.getEURetailInvestorsCount.call(
        country.GERMANY,
      );

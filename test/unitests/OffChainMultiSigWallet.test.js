...
contract('MultisigWallet con OffChainMultisigWallet', function (accounts) {
  let keyFromPw;
  let acct;
  ...
  describe('Calling TestToken transactions with 3 owners and threshold = 2', () => {
    describe('WHEN transferring 1000000 TestToken with an off-chain multisig wallet', () => {
      ...
      beforeEach(async () => {
        ...
        multisig = await OffChainMultisigWallet.new(owners, threshold, CHAINID, { from: accounts[0] });

...
contract IDSLockManager is Initializable, VersionedContract {
    ...
    event InvestorLocked(string investorId, uint256 value, uint256 indexed reason, string reasonString, uint256 releaseTime);
    event InvestorUnlocked(string investorId, uint256 value, uint256 indexed reason, string reasonString, uint256 releaseTime);

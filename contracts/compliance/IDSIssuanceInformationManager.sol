...
contract IDSIssuanceInformationManager is IDSServiceConsumer {
  ...
  */
   ...
   */
    function setInvestorInformation(
        string memory _id,
        uint8 _informationId,
        string memory _hash /*onlyExchangeOrAbove*/
    ) public returns (bool);
    /**
   ...
   * @return A boolean that indicates if the operation was successful.
   */
    function setComplianceInformation(
        uint8 _informationId,
        string memory _value /*onlyIssuerOrAbove*/
    ) public returns (bool);
    /**

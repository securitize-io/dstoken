...
import "./ESStandardTokenVersioned.sol";
import "./ESPausableTokenVersioned.sol";
...
import "./DSTokenInterfaceVersioned.sol";
import "../util/ProxyTargetVersioned.sol";

contract DSTokenVersioned is ProxyTargetVersioned, DSTokenInterfaceVersioned, ESServiceConsumerVersioned, ESPausableTokenVersioned {
  ...
  function initialize(string _name,
    ...
    symbol = _symbol;
    decimals = _decimals;
    eternalStorage = DSEternalStorageVersioned(_storageAddress);

...
contract ESBasicTokenMock is ESBasicToken {
  ...
  constructor(address storageAddress, string namespace, address initialAccount, uint256 initialBalance) EternalStorageClient(storageAddress, namespace) public {

...
export interface WalletRegistrarInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface WalletRegistrar extends BaseContract {
  connect(runner?: ContractRunner | null): WalletRegistrar;
  waitForDeployment(): Promise<this>;

  interface: WalletRegistrarInterface;

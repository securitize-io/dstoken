...
export interface OmnibusTBEControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface OmnibusTBEController extends BaseContract {
  connect(runner?: ContractRunner | null): OmnibusTBEController;
  waitForDeployment(): Promise<this>;

  interface: OmnibusTBEControllerInterface;

...
export interface TokenIssuerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ACCREDITED"
...
export interface TokenIssuer extends BaseContract {
  connect(runner?: ContractRunner | null): TokenIssuer;

...
export interface IDSTrustServiceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "EXCHANGE"
      | "ISSUER"
...
export interface IDSTrustService extends BaseContract {
  connect(runner?: ContractRunner | null): IDSTrustService;
  waitForDeployment(): Promise<this>;

  interface: IDSTrustServiceInterface;

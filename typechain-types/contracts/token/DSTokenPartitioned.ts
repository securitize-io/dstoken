...
export interface DSTokenPartitionedInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface DSTokenPartitioned extends BaseContract {
  connect(runner?: ContractRunner | null): DSTokenPartitioned;
  waitForDeployment(): Promise<this>;

  interface: DSTokenPartitionedInterface;
  ...
  burn: TypedContractMethod<
    [arg0: AddressLike, arg1: BigNumberish, arg2: string],
    [void],
    "view"
  >;
  ...
  seize: TypedContractMethod<
    [arg0: AddressLike, arg1: AddressLike, arg2: BigNumberish, arg3: string],
    [void],
    "view"
  >;

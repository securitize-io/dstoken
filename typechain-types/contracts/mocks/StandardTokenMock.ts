...
export interface StandardTokenMockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface StandardTokenMock extends BaseContract {
  connect(runner?: ContractRunner | null): StandardTokenMock;
  ...
  balanceOfInvestor: TypedContractMethod<[arg0: string], [bigint], "view">;
  ...
  getWalletAt: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  "initialize(address,uint256)": TypedContractMethod<
    [_initialAccount: AddressLike, _initialBalance: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  setCap: TypedContractMethod<[arg0: BigNumberish], [void], "view">;
  ...
  ): TypedContractMethod<[arg0: AddressLike, arg1: string], [void], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "initialize(address,uint256)"
  ): TypedContractMethod<
    [_initialAccount: AddressLike, _initialBalance: BigNumberish],
    [void],
    "nonpayable"

...
export interface IDSServiceConsumerInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  getEvent(
    nameOrSignatureOrTopic: "DSServiceSet" | "Initialized"
  ): EventFragment;
...
export interface IDSServiceConsumer extends BaseContract {
  connect(runner?: ContractRunner | null): IDSServiceConsumer;
  waitForDeployment(): Promise<this>;

  interface: IDSServiceConsumerInterface;

...
export interface ServiceConsumerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ServiceConsumer extends BaseContract {
  connect(runner?: ContractRunner | null): ServiceConsumer;

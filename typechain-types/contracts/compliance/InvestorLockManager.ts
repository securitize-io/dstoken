...
export interface InvestorLockManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface InvestorLockManager extends BaseContract {
  connect(runner?: ContractRunner | null): InvestorLockManager;
  waitForDeployment(): Promise<this>;

  interface: InvestorLockManagerInterface;

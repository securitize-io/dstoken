...
export interface InvestorLockManagerBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface InvestorLockManagerBase extends BaseContract {
  connect(runner?: ContractRunner | null): InvestorLockManagerBase;
  waitForDeployment(): Promise<this>;

  interface: InvestorLockManagerBaseInterface;

...
export interface ComplianceServiceRegulatedInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "getComplianceTransferableTokens"
      | "getDSService"
  ...
  encodeFunctionData(
    functionFragment: "getComplianceTransferableTokens",
...
export interface ComplianceServiceRegulated extends BaseContract {
  connect(runner?: ContractRunner | null): ComplianceServiceRegulated;
  waitForDeployment(): Promise<this>;

  interface: ComplianceServiceRegulatedInterface;
  ...
  getComplianceTransferableTokens: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "getComplianceTransferableTokens"
  ): TypedContractMethod<
    [_who: AddressLike, _time: BigNumberish, _lockTime: BigNumberish],
    [bigint],
    "view"

...
export interface ComplianceServiceNotRegulatedInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ComplianceServiceNotRegulated extends BaseContract {
  connect(runner?: ContractRunner | null): ComplianceServiceNotRegulated;
  waitForDeployment(): Promise<this>;

  interface: ComplianceServiceNotRegulatedInterface;

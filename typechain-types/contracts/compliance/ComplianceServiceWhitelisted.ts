...
export interface ComplianceServiceWhitelistedInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ComplianceServiceWhitelisted extends BaseContract {
  connect(runner?: ContractRunner | null): ComplianceServiceWhitelisted;
  waitForDeployment(): Promise<this>;

  interface: ComplianceServiceWhitelistedInterface;

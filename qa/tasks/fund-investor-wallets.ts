...
task('fund-investor-wallets', 'Send ETH to investor wallets for gas')
  .addOptionalParam('file', 'Path to wallets JSON file (default: qa/tasks/config/fund-investor-wallets.json)', 'qa/tasks/config/fund-investor-wallets.json', types.string)
  ...
  .setAction(async (args, hre) => {
    ...
    if (addresses) {
      ...
      console.log('  --transfersfile qa/tasks/config/transfer-from-investors.json   (extract from transfers file)');
      console.log('  --createinvestorfile qa/output/create-investor+timestamp.json   (extract from create-investor output)');

// qa/update-contracts-scripts/update-tasks.js
...
function updateTaskFiles(addresses) {
  ...
  // List of task files to update (in qa/tasks folder)
  const taskFiles = [
    'create-investor.ts',
    'transfer-from-investors.ts',
    'set-compliance-rules.ts',
    'get-compliance-rules.ts',
    'fund-investor-wallets.ts',
    'issue-tokens.ts'
  ];

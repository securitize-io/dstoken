// qa/update-contracts-scripts/update-console-init.js
...
function main() {
  ...
  if (updateInitFile(addresses)) {
    console.log('✅ Successfully updated qa/update-contracts-scripts/console-init.js with new addresses!');
    console.log('\nYou can now use: npx hardhat console --network <your-network>');
    console.log('Then: .load qa/update-contracts-scripts/console-init.js');
  } else {
